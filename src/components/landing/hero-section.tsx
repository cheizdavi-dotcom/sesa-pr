      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center space-y-6 text-center">
          ...
          <div className="space-y-2">
            <Button asChild size="lg" className="bg-orange-500 hover:bg-orange-600 text-white shadow-lg transition-transform duration-300 hover:scale-105 flex flex-col h-auto py-3">
              <Link href="#products">
